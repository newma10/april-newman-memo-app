...
test('should a button with the text "Delete"',
    () => {
        render(<Memo memo={{}}/>)
...
test('should run onDelete prop passing memo data when "Delete" button is clicked',
    () => {
        ...
        render(<Memo memo={_memo} onDelete={_onDelete}/>)  //_memo here is the memo data object being passed when clicked
        const button = screen.getByText("Delete")
        userEvent.click(button);
